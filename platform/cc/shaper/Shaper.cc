...
extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_shaper_Shaper_00024__1nGetFinalizer(JNIEnv* env, jobject jmodule) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deleteShaper));
}

extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_shaper_Shaper_00024__1nMakePrimitive
  (JNIEnv* env, jobject jmodule) {
    return reinterpret_cast<jlong>(SkShaper::MakePrimitive().release());
}

extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_shaper_Shaper_00024__1nMakeShaperDrivenWrapper
  (JNIEnv* env, jobject jmodule, jlong fontMgrPtr) {
...
extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_shaper_Shaper_00024__1nMakeShapeThenWrap
  (JNIEnv* env, jobject jmodule, jlong fontMgrPtr) {
    SkFontMgr* fontMgr = reinterpret_cast<SkFontMgr*>(static_cast<uintptr_t>(fontMgrPtr));
    return reinterpret_cast<jlong>(SkShaper::MakeShapeThenWrap(sk_ref_sp(fontMgr)).release());
}

extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_shaper_Shaper_00024__1nMakeShapeDontWrapOrReorder
  (JNIEnv* env, jobject jmodule, jlong fontMgrPtr) {
    SkFontMgr* fontMgr = reinterpret_cast<SkFontMgr*>(static_cast<uintptr_t>(fontMgrPtr));
...
extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_shaper_Shaper_00024__1nMakeCoreText
  (JNIEnv* env, jobject jmodule) {
...
extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_shaper_Shaper_00024__1nMake
  (JNIEnv* env, jobject jmodule, jlong fontMgrPtr) {
    SkFontMgr* fontMgr = reinterpret_cast<SkFontMgr*>(static_cast<uintptr_t>(fontMgrPtr));
    return reinterpret_cast<jlong>(SkShaper::Make(sk_ref_sp(fontMgr)).release());
}

extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_shaper_Shaper_00024__1nShapeBlob
  (JNIEnv* env, jobject jmodule, jlong ptr, jstring textObj, jlong fontPtr, jobject opts, jfloat width, jfloat offsetX, jfloat offsetY) {
...
extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_shaper_Shaper_00024__1nShapeLine
  (JNIEnv* env, jobject jmodule, jlong ptr, jstring textObj, jlong fontPtr, jobject opts) {
    SkShaper* instance = reinterpret_cast<SkShaper*>(static_cast<uintptr_t>(ptr));
...
extern "C" JNIEXPORT void JNICALL Java_gay_menkissing_skisca_shaper_Shaper_00024__1nShape
  (JNIEnv* env, jobject jmodule, jlong ptr, jlong textPtr, jobject fontRunIterObj, jobject bidiRunIterObj, jobject scriptRunIterObj, jobject languageRunIterObj, jobject opts, jfloat width, jobject runHandlerObj)
{
    SkShaper* instance = reinterpret_cast<SkShaper*>(static_cast<uintptr_t>(ptr));
