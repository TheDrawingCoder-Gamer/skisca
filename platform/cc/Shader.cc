...
extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_Shader_00024__1nMakeWithColorFilter
  (JNIEnv* env, jobject jmodule, jlong ptr, jlong filterPtr) {
...
extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_Shader_00024__1nMakeLinearGradient
  (JNIEnv* env, jobject jmodule, jfloat x0, jfloat y0, jfloat x1, jfloat y1, jintArray colorsArray, jfloatArray posArray, jint tileModeInt, jint flags, jfloatArray matrixArray) {
...
extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_Shader_00024__1nMakeLinearGradientCS
  (JNIEnv* env, jobject jmodule, jfloat x0, jfloat y0, jfloat x1, jfloat y1, jfloatArray colorsArray, jlong colorSpacePtr, jfloatArray posArray, jint tileModeInt, jint flags, jfloatArray matrixArray) {
    SkPoint pts[2] {SkPoint::Make(x0, y0), SkPoint::Make(x1, y1)};
...
extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_Shader_00024__1nMakeRadialGradient
  (JNIEnv* env, jobject jmodule, jfloat x, jfloat y, jfloat r, jintArray colorsArray, jfloatArray posArray, jint tileModeInt, jint flags, jfloatArray matrixArray) {
    jint* colors = env->GetIntArrayElements(colorsArray, nullptr);
    float* pos = posArray == nullptr ? nullptr : env->GetFloatArrayElements(posArray, nullptr);
    SkTileMode tileMode = static_cast<SkTileMode>(tileModeInt);
    std::unique_ptr<SkMatrix> localMatrix = skMatrix(env, matrixArray);
...
extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_Shader_00024__1nMakeRadialGradientCS
  (JNIEnv* env, jobject jmodule, jfloat x, jfloat y, jfloat r, jfloatArray colorsArray, jlong colorSpacePtr, jfloatArray posArray, jint tileModeInt, jint flags, jfloatArray matrixArray) {
    float* colors = env->GetFloatArrayElements(colorsArray, nullptr);
    sk_sp<SkColorSpace> colorSpace = sk_ref_sp<SkColorSpace>(reinterpret_cast<SkColorSpace*>(static_cast<uintptr_t>(colorSpacePtr)));
    float* pos = env->GetFloatArrayElements(posArray, nullptr);
    SkTileMode tileMode = static_cast<SkTileMode>(tileModeInt);
...
extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_Shader_00024__1nMakeTwoPointConicalGradient
  (JNIEnv* env, jobject jmodule, jfloat x0, jfloat y0, jfloat r0, jfloat x1, jfloat y1, jfloat r1, jintArray colorsArray, jfloatArray posArray, jint tileModeInt, jint flags, jfloatArray matrixArray) {
    jint* colors = env->GetIntArrayElements(colorsArray, nullptr);
    float* pos = posArray == nullptr ? nullptr : env->GetFloatArrayElements(posArray, nullptr);
    SkTileMode tileMode = static_cast<SkTileMode>(tileModeInt);
    std::unique_ptr<SkMatrix> localMatrix = skMatrix(env, matrixArray);
...
extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_Shader_00024__1nMakeTwoPointConicalGradientCS
  (JNIEnv* env, jobject jmodule, jfloat x0, jfloat y0, jfloat r0, jfloat x1, jfloat y1, jfloat r1, jfloatArray colorsArray, jlong colorSpacePtr, jfloatArray posArray, jint tileModeInt, jint flags, jfloatArray matrixArray) {
    float* colors = env->GetFloatArrayElements(colorsArray, nullptr);
    sk_sp<SkColorSpace> colorSpace = sk_ref_sp<SkColorSpace>(reinterpret_cast<SkColorSpace*>(static_cast<uintptr_t>(colorSpacePtr)));
    float* pos = env->GetFloatArrayElements(posArray, nullptr);
    SkTileMode tileMode = static_cast<SkTileMode>(tileModeInt);
...
extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_Shader_00024__1nMakeSweepGradient
  (JNIEnv* env, jobject jmodule, jfloat x, jfloat y, jfloat start, jfloat end, jintArray colorsArray, jfloatArray posArray, jint tileModeInt, jint flags, jfloatArray matrixArray) {
    jint* colors = env->GetIntArrayElements(colorsArray, nullptr);
    float* pos = posArray == nullptr ? nullptr : env->GetFloatArrayElements(posArray, nullptr);
    SkTileMode tileMode = static_cast<SkTileMode>(tileModeInt);
    std::unique_ptr<SkMatrix> localMatrix = skMatrix(env, matrixArray);
...
extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_Shader_00024__1nMakeSweepGradientCS
  (JNIEnv* env, jobject jmodule, jfloat x, jfloat y, jfloat start, jfloat end, jfloatArray colorsArray, jlong colorSpacePtr, jfloatArray posArray, jint tileModeInt, jint flags, jfloatArray matrixArray) {
    float* colors = env->GetFloatArrayElements(colorsArray, nullptr);
    sk_sp<SkColorSpace> colorSpace = sk_ref_sp<SkColorSpace>(reinterpret_cast<SkColorSpace*>(static_cast<uintptr_t>(colorSpacePtr)));
    float* pos = env->GetFloatArrayElements(posArray, nullptr);
    SkTileMode tileMode = static_cast<SkTileMode>(tileModeInt);
...
extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_Shader_00024__1nMakeEmpty(JNIEnv* env, jobject jmodule) {
    SkShader* ptr = SkShaders::Empty().release();
    return reinterpret_cast<jlong>(ptr);
}

extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_Shader_00024__1nMakeColor(JNIEnv* env, jobject jmodule, jint color) {
    SkShader* ptr = SkShaders::Color(color).release();
    return reinterpret_cast<jlong>(ptr);
}

extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_Shader_00024__1nMakeColorCS(JNIEnv* env, jobject jmodule, jfloat r, jfloat g, jfloat b, jfloat a, jlong colorSpacePtr) {
    SkColorSpace* colorSpace = reinterpret_cast<SkColorSpace*>(static_cast<uintptr_t>(colorSpacePtr));
    SkShader* ptr = SkShaders::Color(SkColor4f{r, g, b, a}, sk_ref_sp<SkColorSpace>(colorSpace)).release();
    return reinterpret_cast<jlong>(ptr);
}

extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_Shader_00024__1nMakeBlend(JNIEnv* env, jobject jmodule, jint blendModeInt, jlong dstPtr, jlong srcPtr) {
