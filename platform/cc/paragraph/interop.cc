    ...
    namespace paragraph {
        namespace LineMetrics {
            ...
            void onLoad(JNIEnv* env) {
                jclass local = env->FindClass("gay/menkissing/skisca/paragraph/LineMetrics");
        ...
        namespace TextBox {
            ...
            void onLoad(JNIEnv* env) {
                jclass local = env->FindClass("gay/menkissing/skisca/paragraph/TextBox");
                cls  = static_cast<jclass>(env->NewGlobalRef(local));
        ...
        namespace DecorationStyle {
            ...
            void onLoad(JNIEnv* env) {
                jclass local = env->FindClass("gay/menkissing/skisca/paragraph/DecorationStyle");
                cls  = static_cast<jclass>(env->NewGlobalRef(local));
        ...
        namespace Shadow {
            ...
            void onLoad(JNIEnv* env) {
                jclass local = env->FindClass("gay/menkissing/skisca/paragraph/Shadow");
                cls  = static_cast<jclass>(env->NewGlobalRef(local));
