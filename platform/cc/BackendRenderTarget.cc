...
extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_BackendRenderTarget_00024__1nGetFinalizer
  (JNIEnv* env, jobject obj) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deleteBackendRenderTarget));
}

extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_BackendRenderTarget_00024__1nMakeGL
  (JNIEnv* env, jobject obj, jint width, jint height, jint sampleCnt, jint stencilBits, jint fbId, jint fbFormat) {
...
#ifdef SK_METAL
extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_BackendRenderTarget_00024__1nMakeMetal
  (JNIEnv* env, jobject obj, jint width, jint height, jlong texturePtr) {
...
extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_BackendRenderTarget_00024__1nMakeDirect3D
  (JNIEnv* env, jobject obj, jint width, jint height, jlong texturePtr, jint format, jint sampleCnt, jint levelCnt) {
