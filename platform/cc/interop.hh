...
namespace skija {
    ...
    namespace PathSegment {
        extern jclass mod;
        extern jobject modInst;
        extern jfieldID Done;
        extern jmethodID makeMove;
        extern jmethodID makeClose;
        extern jmethodID makeLine;
        extern jmethodID makeQuad;
        extern jmethodID makeConic;
        extern jmethodID makeCubic;
        void onLoad(JNIEnv* env);
        void onUnload(JNIEnv* env);
    }
