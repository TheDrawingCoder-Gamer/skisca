...
namespace skija {
    namespace AnimationFrameInfo {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("gay/menkissing/skisca/AnimationFrameInfo");
            cls  = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace Color4f {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("gay/menkissing/skisca/Color4f");
            cls  = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace Drawable {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("gay/menkissing/skisca/Drawable");
            cls = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace FontFamilyName {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("gay/menkissing/skisca/FontFamilyName");
            cls  = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace FontFeature {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("gay/menkissing/skisca/FontFeature");
            cls  = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace FontMetrics {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("gay/menkissing/skisca/FontMetrics");
            cls  = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace FontMgr {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("gay/menkissing/skisca/FontMgr");
            cls = static_cast<jclass>(env->NewGlobalRef(local));
        }
    ...
    namespace FontVariation {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("gay/menkissing/skisca/FontVariation");    
            cls   = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace FontVariationAxis {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("gay/menkissing/skisca/FontVariationAxis");
            cls  = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace ImageInfo {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("gay/menkissing/skisca/ImageInfo");    
            cls   = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace Path {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("gay/menkissing/skisca/Path");
            cls          = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace PathSegment {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("gay/menkissing/skisca/PathSegment$");
            mod = static_cast<jclass>(env->NewGlobalRef(local));
            jfieldID modField = env->GetStaticFieldID(mod, "MODULE$", "Lgay/menkissing/skisca/PathSegment$;");
            modInst = env->GetStaticObjectField(mod, modField);

            Done      = env->GetStaticFieldID(mod, "Done", "Lgay/menkissing/skisca/PathSegment;");
            makeMove      = env->GetMethodID(mod, "makeMove", "(FFZ)Lgay/menkissing/skisca/PathSegment;");
            makeClose      = env->GetMethodID(mod, "makeClose", "(FFZ)Lgay/menkissing/skisca/PathSegment;");
            makeLine      = env->GetMethodID(mod, "makeLine", "(FFFFZZ)Lgay/menkissing/skisca/PathSegment;");
            makeQuad      = env->GetMethodID(mod, "makeQuad", "(FFFFFFZ)Lgay/menkissing/skisca/PathSegment;");
            makeConic     = env->GetMethodID(mod, "makeConic", "(FFFFFFFZ)Lgay/menkissing/skisca/PathSegment;");
            makeCubic     = env->GetMethodID(mod, "makeCubic", "(FFFFFFFFZ)Lgay/menkissing/skisca/PathSegment;");
        }

        void onUnload(JNIEnv* env) {
            env->DeleteGlobalRef(mod);
        }
    }
    ...
    namespace PaintFilterCanvas {
        ...
        void onLoad(JNIEnv* env) {
            env->GetJavaVM(&_vm);
            jclass local = env->FindClass("gay/menkissing/skisca/PaintFilterCanvas");
   ...
   namespace RSXform {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("gay/menkissing/skisca/RSXform");
            cls  = static_cast<jclass>(env->NewGlobalRef(local));
            ctor = env->GetMethodID(cls, "<init>", "(FFFF)V");
        }
    ...
    namespace SurfaceProps {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("gay/menkissing/skisca/SurfaceProps");
            cls = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace impl {
        namespace Native {
            ...
            void onLoad(JNIEnv* env) {
                jclass cls = env->FindClass("gay/menkissing/skisca/impl/Native");
