...
extern "C" {
    JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_Pixmap__1nGetFinalizer
      (JNIEnv *env, jclass klass) {
        return ptrToJlong(&deletePixmap);
    }

    JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_Pixmap__1nMakeNull
      (JNIEnv *env, jclass klass) {
        return ptrToJlong(new SkPixmap());
    }

    JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_Pixmap__1nMake
      (JNIEnv *env, jclass klass,
    ...
    JNIEXPORT void JNICALL Java_gay_menkissing_skisca_Pixmap__1nReset
      (JNIEnv *env, jclass klass, jlong ptr) {
        SkPixmap* pixmap = jlongToPtr<SkPixmap*>(ptr);
        pixmap->reset();
    }

    JNIEXPORT void JNICALL Java_gay_menkissing_skisca_Pixmap__1nResetWithInfo
      (JNIEnv *env, jclass klass, jlong ptr,
      jint width, jint height, jint colorType, jint alphaType, jlong colorSpacePtr, jlong pixelsPtr, jint rowBytes) {
        SkPixmap* pixmap = jlongToPtr<SkPixmap*>(ptr);
        SkColorSpace* colorSpace = jlongToPtr<SkColorSpace*>(colorSpacePtr);
    ...
    JNIEXPORT void JNICALL Java_gay_menkissing_skisca_Pixmap__1nSetColorSpace
    ...
    JNIEXPORT jboolean JNICALL Java_gay_menkissing_skisca_Pixmap__1nExtractSubset
      (JNIEnv *env, jclass klass, jlong ptr,
    ...
    JNIEXPORT jobject JNICALL Java_gay_menkissing_skisca_Pixmap__1nGetInfo
      (JNIEnv *env, jclass klass, jlong ptr) {
        SkPixmap* pixmap = jlongToPtr<SkPixmap*>(ptr);
    ...
    JNIEXPORT jint JNICALL Java_gay_menkissing_skisca_Pixmap__1nGetRowBytes
      (JNIEnv *env, jclass klass, jlong ptr) {
        SkPixmap* pixmap = jlongToPtr<SkPixmap*>(ptr);
        return static_cast<jint>(pixmap->rowBytes());
    }

    JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_Pixmap__1nGetAddr
      (JNIEnv *env, jclass klass, jlong ptr) {
        SkPixmap* pixmap = jlongToPtr<SkPixmap*>(ptr);
        return ptrToJlong(pixmap->addr());
    }

    JNIEXPORT jint JNICALL Java_gay_menkissing_skisca_Pixmap__1nGetRowBytesAsPixels
      (JNIEnv *env, jclass klass, jlong ptr) {
        SkPixmap* pixmap = jlongToPtr<SkPixmap*>(ptr);
        return static_cast<jint>(pixmap->rowBytesAsPixels());
    }

    JNIEXPORT jint JNICALL Java_gay_menkissing_skisca_Pixmap__1nComputeByteSize
      (JNIEnv *env, jclass klass, jlong ptr) {
        SkPixmap* pixmap = jlongToPtr<SkPixmap*>(ptr);
        return static_cast<jint>(pixmap->computeByteSize());
    }

    JNIEXPORT jboolean JNICALL Java_gay_menkissing_skisca_Pixmap__1nComputeIsOpaque
      (JNIEnv *env, jclass klass, jlong ptr) {
        SkPixmap* pixmap = jlongToPtr<SkPixmap*>(ptr);
        return static_cast<jboolean>(pixmap->computeIsOpaque());
    }

    JNIEXPORT jint JNICALL Java_gay_menkissing_skisca_Pixmap__1nGetColor
      (JNIEnv *env, jclass klass, jlong ptr, jint x, jint y) {
        SkPixmap* pixmap = jlongToPtr<SkPixmap*>(ptr);
        return static_cast<jint>(pixmap->getColor(x, y));
    }

    JNIEXPORT jobject JNICALL Java_gay_menkissing_skisca_Pixmap__1nGetColor4f
      (JNIEnv *env, jclass klass, jlong ptr, jint x, jint y) {
        SkPixmap* pixmap = jlongToPtr<SkPixmap*>(ptr);
    ...
    JNIEXPORT jfloat JNICALL Java_gay_menkissing_skisca_Pixmap__1nGetAlphaF
      (JNIEnv *env, jclass klass, jlong ptr, jint x, jint y) {
        SkPixmap* pixmap = jlongToPtr<SkPixmap*>(ptr);
        return static_cast<jfloat>(pixmap->getAlphaf(x, y));
    }

    JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_Pixmap__1nGetAddrAt
      (JNIEnv *env, jclass klass, jlong ptr, jint x, jint y) {
        SkPixmap* pixmap = jlongToPtr<SkPixmap*>(ptr);
        return reinterpret_cast<jlong>(pixmap->addr(x, y));
    }

    JNIEXPORT jboolean JNICALL Java_gay_menkissing_skisca_Pixmap__1nReadPixels
      (JNIEnv *env, jclass klass, jlong ptr,
      jint width, jint height, jint colorType, jint alphaType, jlong colorSpacePtr, jlong pixelsPtr, jint rowBytes) {
        SkPixmap* pixmap = jlongToPtr<SkPixmap*>(ptr);
        SkColorSpace* colorSpace = jlongToPtr<SkColorSpace*>(colorSpacePtr);
    ...
    JNIEXPORT jboolean JNICALL Java_gay_menkissing_skisca_Pixmap__1nReadPixelsFromPoint
      (JNIEnv *env, jclass klass, jlong ptr,
      jint width, jint height, jint colorType, jint alphaType, jlong colorSpacePtr, jlong pixelsPtr, jint rowBytes,
      jint srcX, jint srcY) {
        SkPixmap* pixmap = jlongToPtr<SkPixmap*>(ptr);
    ...
    JNIEXPORT jboolean JNICALL Java_gay_menkissing_skisca_Pixmap__1nReadPixelsToPixmap
    ...
    JNIEXPORT jboolean JNICALL Java_gay_menkissing_skisca_Pixmap__1nReadPixelsToPixmapFromPoint
    ...
    JNIEXPORT jboolean JNICALL Java_gay_menkissing_skisca_Pixmap__1nScalePixels
    ...
    JNIEXPORT jboolean JNICALL Java_gay_menkissing_skisca_Pixmap__1nErase
      (JNIEnv *env, jclass klass, jlong ptr, jint color) {
        SkPixmap* pixmap = jlongToPtr<SkPixmap*>(ptr);
        return static_cast<jboolean>(pixmap->erase(color));
    }

    JNIEXPORT jboolean JNICALL Java_gay_menkissing_skisca_Pixmap__1nEraseSubset
