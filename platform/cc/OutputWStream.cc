...
extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_OutputWStream_00024__1nGetFinalizer
  (JNIEnv* env, jobject) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deleteOutputWStream));
}

extern "C" JNIEXPORT jlong JNICALL Java_gay_menkissing_skisca_OutputWStream_00024__1nMake
  (JNIEnv* env, jobject, jobject outputStream) {
