...
public abstract class Scene {
    public static final Typeface inter = Typeface.makeFromFile("samples/scenes/fonts/InterHinted-Regular.ttf");
    public static final Typeface jbMono = Typeface.makeFromFile("samples/scenes/fonts/JetBrainsMono-Regular.ttf");
    public static final Font     inter13 = new Font(inter, 13).setSubpixel(true);
    public static final Paint    blackFill = Paint.apply().setColor(0xFF000000);
    ...
    public static void drawStringCentered(Canvas canvas, String text, float x, float y, Font font, Paint paint) {
        ...
        float lineHeight = font.getMetrics().capHeight();
    ...
    public static void drawStringLeft(Canvas canvas, String text, Rect outer, Font font, Paint paint) {
        ...
        float innerHeight = metrics.descent() - metrics.ascent();

        canvas.drawString(text,
            outer.getLeft(), 
            outer.getTop() + (outer.getHeight() - innerHeight) / 2f - metrics.ascent(),
            font, paint);
    }
