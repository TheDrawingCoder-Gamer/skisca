...
public class PathsScene extends Scene {
    ...
    public void draw(Canvas canvas, int width, int height, float dpi, int xpos, int ypos) {
        ...
        drawPaths(canvas, Paint.apply().setColor(0xFFF6BC01));
        drawPaths(canvas, Paint.apply().setColor(0xFF437AA0).setMode(PaintMode.STROKE).setStrokeWidth(1f));
        drawAdds(canvas);
    ...
    public void drawPaths(Canvas canvas, Paint paint) {
        var tangentStroke = Paint.apply().setColor(0xFFFAA6B2).setMode(PaintMode.STROKE).setStrokeWidth(1f);
    ...
    private void drawAdds(Canvas canvas) {
        canvas.save();
        try (var path = Path.apply();
             var paint = Paint.apply().setColor(0xFF437AA0).setMode(PaintMode.STROKE).setStrokeWidth(1f)) {
            ...
            // addPath
            try (Path subpath = Path.apply().addRect(Rect.makeLTRB(0, 0, 10, 10)).closePath()) {
    ...
    private void drawTransforms(Canvas canvas) {
        ...
        try (var path = Path.apply();
             var paint = Paint.apply().setColor(0xFF437AA0).setMode(PaintMode.STROKE).setStrokeWidth(1f);
             var secondaryPaint = Paint.apply().setColor(0xFFFAA6B2).setMode(PaintMode.STROKE).setStrokeWidth(1f);) {
            ...
            try (Path subpath = Path.apply().addRRect(RRect.makeLTRB(0, 0, 20, 20, 5))) {
    ...
    private void drawFillPaths(Canvas canvas) {
        ...
        try (Path path = Path.apply().moveTo(20, 5).lineTo(35, 35).lineTo(5, 35).closePath();
             Paint stroke1 = Paint.apply().setColor(0xFF247ba0).setMode(PaintMode.STROKE).setStrokeWidth(1))
        {
            Paint[] paints = new Paint[] {
                Paint.apply().setColor(0xFFffe066).setMode(PaintMode.STROKE).setStrokeWidth(10),
                Paint.apply().setColor(0xFFffe066).setMode(PaintMode.STROKE).setStrokeWidth(10).setStrokeMiter(2),
                Paint.apply().setColor(0xFFffe066).setMode(PaintMode.STROKE).setStrokeWidth(10).setStrokeJoin(PaintStrokeJoin.ROUND),
                Paint.apply().setColor(0xFFffe066).setMode(PaintMode.STROKE).setStrokeWidth(10).setStrokeJoin(PaintStrokeJoin.BEVEL)
            };
        ...
        try (Path path = Path.apply().moveTo(5, 35).lineTo(15, 10).lineTo(25, 30).lineTo(35, 5);
             Paint stroke1 = Paint.apply().setColor(0xFF247ba0).setMode(PaintMode.STROKE).setStrokeWidth(1))
        {
            Paint[] paints = new Paint[] {
                Paint.apply().setColor(0xFFffe066).setMode(PaintMode.STROKE).setStrokeWidth(10),
                Paint.apply().setColor(0xFFffe066).setMode(PaintMode.STROKE).setStrokeWidth(10).setStrokeCap(PaintStrokeCap.ROUND),
                Paint.apply().setColor(0xFFffe066).setMode(PaintMode.STROKE).setStrokeWidth(10).setStrokeCap(PaintStrokeCap.SQUARE)
            };
            for (Paint stroke5: paints) {
                canvas.drawPath(path, stroke5);
                canvas.drawPath(path, stroke1);
    ...
    private void drawPathsOp(Canvas canvas) {
        ...
        try (
                Paint paint1 = Paint.apply().setMode(PaintMode.FILL).setColor(0xFF437AA0);
                Paint paint2 = Paint.apply().setMode(PaintMode.FILL).setColor(0x80FAA6B2);
                Paint paint3 = Paint.apply().setMode(PaintMode.FILL).setColor(0xFFF6BC01);
                Path one = Path.apply();
                Path two = Path.apply();
        ) {
            one.moveTo(5, 5);
    ...
    private void drawInterpolate(Canvas canvas) {
        ...
        try (Path p1 = Path.apply().moveTo(0, 14).lineTo(20, 14).lineTo(20, 0).lineTo(40, 20).lineTo(20, 40).lineTo(20, 26).lineTo(0, 26).lineTo(0, 14).closePath();
             Path p2 = Path.apply().moveTo(0, 20).lineTo(14, 20).lineTo(14, 0).lineTo(26, 0).lineTo(26, 20).lineTo(40, 20).lineTo(20, 40).lineTo(0, 20).closePath();
             Path p3 = Path.apply().moveTo(0, 20).lineTo(20, 0).lineTo(20, 14).lineTo(40, 14).lineTo(40, 26).lineTo(20, 26).lineTo(20, 40).lineTo(0, 20).closePath();
             Path p4 = Path.apply().moveTo(0, 20).lineTo(20, 0).lineTo(40, 20).lineTo(26, 20).lineTo(26, 40).lineTo(14, 40).lineTo(14, 20).lineTo(0, 20).closePath();
             Path target = pair == 0 ? p1.makeLerp(p2, weight)
                         : pair == 1 ? p2.makeLerp(p3, weight)
                         : pair == 2 ? p3.makeLerp(p4, weight)
                         : p4.makeLerp(p1, weight);
             Paint stroke = Paint.apply().setColor(0xFF437AA0).setMode(PaintMode.STROKE).setStrokeWidth(1);)
        {
    ...
    private void drawMeasure(Canvas canvas) {
        ...
        try (var path = Path.apply().addCircle(20, 20, 20, PathDirection.COUNTER_CLOCKWISE);
             var measure = new PathMeasure(path, false);
             var segment = Path.apply();
             var arcStroke = Paint.apply().setColor(0xFF437AA0).setMode(PaintMode.STROKE).setStrokeWidth(1);
             var tangentStroke = Paint.apply().setColor(0xFFFAA6B2).setMode(PaintMode.STROKE).setStrokeWidth(1);)
        {
