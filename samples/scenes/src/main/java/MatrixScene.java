...
public class MatrixScene extends Scene {
    ...
    public void draw(Canvas canvas, int width, int height, float dpi, int xpos, int ypos) {
        ...
        try (var stroke = Paint.apply().setColor(0x40000000).setMode(PaintMode.STROKE).setStrokeWidth(1)) {
            canvas.save();
            ...
            var m44 = canvas.getLocalToDevice().mat();
            var m33 = canvas.getLocalToDeviceAsMatrix33().mat();
            canvas.restore();
            ...
            canvas.drawRect(Rect.makeLTRB(-10, -10, 10, 10), blackFill);
            m44 = canvas.getLocalToDevice().mat();
            m33 = canvas.getLocalToDeviceAsMatrix33().mat();
            canvas.restore();
